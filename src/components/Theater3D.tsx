...
// --- DATA (Updated with HTTPS Video Links for Deployment) ---
const movies = [
  {
    id: '1',
...
// Separated to handle Suspense locally and cleanly
  ...
  return (
    <group position={[0, SCREEN_Y, SCREEN_Z]}>
      ...
      <mesh position={[0, 0, 0]}>
        ...
        {/* Suspense is crucial here to prevent the whole app from freezing while video buffers */}
